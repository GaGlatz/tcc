...
import { formatTelefone } from "../../util";
...
const ModalComponent = ({ components, form, remove, setComponents }) => {
  return (
    <Modal
...
const TableComponent = ({ clientes, form, onRowClick, setComponents }) => {
  const dispatch = useDispatch();
        ...
        <Table
          ...
          config={[
            ...
            },
            {
              ...
              key: "telefone",
              content: (telefone) => formatTelefone(telefone),
              sortable: true,
              width: 200,
            },
            {
